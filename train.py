...
parser.add_argument('--model',type=str,default='DDAMGCN',help='adj type')
...
parser.add_argument('--k_num', type=int,default=50,help='number of key node')
...
class trainer():
    def __init__(self, in_dim, seq_length, k_num, num_nodes, nhid, l, dropout, lrate, wdecay, device, supports, decay):
        self.model = DDAMGCN(device, k_num, num_nodes, l, dropout, supports=supports,
...
def main():
    ...
    engine = trainer( args.in_dim, args.seq_length, args.k_num, args.num_nodes, args.nhid, args.l,args.dropout,
